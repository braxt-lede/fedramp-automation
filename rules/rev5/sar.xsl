...
<xsl:template match="/">
   ...
   <!--SCHEMATRON PATTERNS-->
<doc:xspec xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" href="../../test/rules/rev5/sar.xspec"/>
...
The result, <xsl:text/>
      ...
      <xsl:variable name="pl-2-other-than-satisfied-findings" select="oscal:finding/oscal:target[@type = 'objective-id'][oscal:status eq 'not-satisfied'][matches(@target-id, '^pl-2\.')]/@target-id"/>
...
The implementation-status of the target, <xsl:text/>
      ...
      <xsl:variable name="satisfaction-status" select="'satisfied', 'not-satisfied'"/>
      <!--ASSERT error-->
<xsl:choose>
