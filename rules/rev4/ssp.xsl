...
<!--KEYS AND FUNCTIONS-->
<xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" name="lv:if-empty-default">
      <xsl:param name="item"/>
   ...
   <xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="item()*" name="lv:registry">
      <xsl:sequence select="$registry"/>
   </xsl:function>
   <xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="xs:string" name="lv:sensitivity-level">
      <xsl:param as="node()*" name="context"/>
      <xsl:value-of select="$context//oscal:security-sensitivity-level"/>
   </xsl:function>
   <xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="document-node()*" name="lv:profile">
   ...
   <xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" name="lv:correct">
   ...
   <xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" name="lv:analyze">
      <xsl:param as="element()*" name="value-set"/>
   ...
   <xsl:function xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="xs:string" name="lv:report">
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA SETUP-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="FedRAMP System Security Plan Validations" schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans Appendix A</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.4</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.3</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.5</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §6.5</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.17 Authorization Boundary Diagram</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.22 Network Architecture Diagram</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.24 Data Flow Diagram</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<doc:xspec xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" href="../../test/rules/rev4/ssp.xspec"/>
   <xsl:param xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="xs:boolean" name="param-use-remote-resources" select="false()"/>
   <xsl:param name="use-remote-resources" select="$param-use-remote-resources or matches(lower-case(environment-variable('use_remote_resources')), '1|true')"/>
   <xsl:param xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="xs:boolean" name="param-use-debug-mode" select="false()"/>
   <xsl:param name="use-debug-mode" select="$param-use-debug-mode or matches(lower-case(environment-variable('use_debug_mode')), '1|true')"/>
...
<xsl:if test="$use-debug-mode eq true()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$use-debug-mode eq true()">
...
<xsl:if test="$use-debug-mode eq true()">
   ...
   <xsl:output xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" encoding="UTF-8" indent="yes" method="xml"/>
   ...
   <xsl:param xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="xs:string" name="baselines-base-path" select="'../../../../dist/content/rev4/baselines/xml'"/>
   <xsl:param name="registry" select="doc(concat($registry-base-path, '/fedramp_values.xml')) | doc(concat($registry-base-path, '/fedramp_threats.xml')) | doc(concat($registry-base-path, '/information-types.xml'))"/>
   <xsl:template xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="element()" name="analysis-template">
      <xsl:param as="element()*" name="value-set"/>
      <xsl:param as="element()*" name="element"/>
   ...
   <xsl:template xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" as="xs:string" name="report-template">
      <xsl:param as="element()*" name="analysis"/>
...
<xsl:template match="/oscal:system-security-plan" priority="1010" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan"/>
      <xsl:variable name="ok-values" select="$registry/f:fedramp-values/f:value-set[@name eq 'security-level']"/>
      <xsl:variable name="sensitivity-level" select="/ =&gt; lv:sensitivity-level() =&gt; lv:if-empty-default('')"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count($registry/f:fedramp-values/f:value-set) &gt; 0">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty($ok-values) or not(exists($corrections))">
      ...
      <xsl:variable name="implemented" select="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement"/>
      <!--REPORT information-->
<xsl:if test="$use-debug-mode eq true()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$use-debug-mode eq true()">
   ...
   <!--RULE -->
<xsl:template match="oscal:system-security-plan/oscal:system-implementation/oscal:component" priority="1009" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-security-plan/oscal:system-implementation/oscal:component"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:description/oscal:p/text()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:description/oscal:p/text()">
...
Component _<xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:title"/>_ is missing a description.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M40"/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:control-implementation" priority="1008" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:control-implementation"/>
      <xsl:variable name="registry-ns" select="$registry/f:fedramp-values/f:namespace/f:ns/@ns"/>
      <xsl:variable name="sensitivity-level" select="/ =&gt; lv:sensitivity-level()"/>
      <xsl:variable name="ok-values" select="$registry/f:fedramp-values/f:value-set[@name eq 'control-implementation-status']"/>
      ...
      <xsl:variable name="all-missing" select="$required-controls[not(@id = $implemented/@control-id)]"/>
      <xsl:variable name="core-missing" select="$required-controls[oscal:prop[@name eq 'CORE' and @ns = $registry-ns] and @id = $all-missing/@id]"/>
      <xsl:variable name="extraneous" select="$implemented[not(@control-id = $required-controls/@id)]"/>
      <!--REPORT information-->
<xsl:if test="$use-debug-mode eq true()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$use-debug-mode eq true()">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists($core-missing))">
               <xsl:attribute name="id">incomplete-core-implemented-requirements</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>A FedRAMP SSP must implement the most important controls.</svrl:text>
               <svrl:diagnostic-reference diagnostic="incomplete-core-implemented-requirements-diagnostic">
A FedRAMP SSP must implement the most important <xsl:text/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists($all-missing))">
...
A FedRAMP SSP must implement <xsl:text/>
      ...
      <xsl:variable name="results" select="$ok-values =&gt; lv:analyze(//oscal:implemented-requirement/oscal:prop[@name eq 'implementation-status'])"/>
      <xsl:variable name="total" select="$results/reports/@count"/>
      <!--REPORT information-->
<xsl:if test="count($results/errors/error) = 0 and $use-debug-mode eq true()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count($results/errors/error) = 0 and $use-debug-mode eq true()">
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement" priority="1007" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement"/>
      <xsl:variable name="sensitivity-level" select="/ =&gt; lv:sensitivity-level() =&gt; lv:if-empty-default('')"/>
      <xsl:variable name="selected-profile" select="$sensitivity-level =&gt; lv:profile()"/>
      <xsl:variable name="registry-ns" select="$registry/f:fedramp-values/f:namespace/f:ns/@ns"/>
      <xsl:variable name="status" select="./oscal:prop[@name eq 'implementation-status']/@value"/>
      <xsl:variable name="corrections" select="lv:correct($registry/f:fedramp-values/f:value-set[@name eq 'control-implementation-status'], $status)"/>
      <xsl:variable name="required-response-points" select="$selected-profile/oscal:catalog//oscal:part[@name eq 'item']"/>
      <xsl:variable name="implemented" select="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement"/>
      <xsl:variable name="missing" select="$required-response-points[not(@id = $implemented/@statement-id)]"/>
      <xsl:variable name="leveraged" select="//oscal:system-implementation/oscal:leveraged-authorization"/>
      <xsl:variable name="familyName" select="substring-before(@control-id, '-')"/>
      <xsl:variable name="leveragedUUID" select="oscal:prop[@name = 'leveraged-authorization-uuid']/@value"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="                     if ($familyName eq 'pe')                     then                         if ($leveraged/@uuid = $leveragedUUID)                         then                             (true())                         else                             (false())                     else                         true()"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if ($familyName eq 'pe') then if ($leveraged/@uuid = $leveragedUUID) then (true()) else (false()) else true()">
               <xsl:attribute name="id">leveraged-PE-controls-implemented-requirement</xsl:attribute>
               <xsl:attribute name="role">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>This PE Control has a leveraged authorization - <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/>.</svrl:text>
               <svrl:diagnostic-reference diagnostic="leveraged-PE-controls-implemented-requirement-diagnostic">
This PE Control does not have a matching leveraged authorization - <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/>.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT information-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists($corrections))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (matches(@control-id, 'sc-20|sc-21')) then (if (self::oscal:implemented-requirement//*[matches(., 'DNSSEC|DNS Security Extensions')]) then (true()) else (false())) else (true())">
               <xsl:attribute name="id">DNSSEC-described</xsl:attribute>
               <xsl:attribute name="role">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Implemented Requirement <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/> exists.</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (matches(@control-id, 'cm-9')) then (if (self::oscal:implemented-requirement//*[matches(., 'CIS|Center for Internet Security|SCAP')]) then (true()) else (false())) else (true())">
               ...
               <svrl:text>Implemented Requirement <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/> exists and has acceptable keywords.</svrl:text>
...
The implemented requirement <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement" priority="1006" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:by-component)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(oscal:description))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists(oscal:remarks))">
...
Response statement <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement/oscal:by-component" priority="1005" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement/oscal:by-component"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="/oscal:system-security-plan/oscal:system-implementation/oscal:component[@uuid eq $component-ref] =&gt; exists()">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="./oscal:description =&gt; exists()">
...
Response statement <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement/oscal:by-component/oscal:description" priority="1004" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement/oscal:by-component/oscal:description"/>
      <xsl:variable name="required-length" select="20"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$description-length ge $required-length">
...
Response statement component description for <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement/oscal:by-component/oscal:remarks" priority="1003" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:control-implementation/oscal:implemented-requirement/oscal:statement/oscal:by-component/oscal:remarks"/>
      <xsl:variable name="required-length" select="20"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$remarks-length ge $required-length">
...
Response statement component remarks for <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:metadata" priority="1002" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:metadata"/>
      ...
      <xsl:variable name="extraneous-roles" select="$responsible-parties[not(@role-id = $roles/@id)]"/>
      <xsl:variable name="extraneous-parties" select="$responsible-parties[not(oscal:party-uuid = $parties/@uuid)]"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="not(exists($extraneous-roles))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists($extraneous-roles))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(exists($extraneous-parties))">
...
A FedRAMP SSP must define a responsible party with <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:back-matter/oscal:resource" priority="1001" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:back-matter/oscal:resource"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="@uuid"/>
         <xsl:otherwise>
...
This FedRAMP SSP has a back-matter resource which lacks a UUID.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:back-matter/oscal:resource/oscal:base64" priority="1000" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:back-matter/oscal:resource/oscal:base64"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Basic resource constraints</svrl:text>
   <xsl:variable name="attachment-types" select="$fedramp-values//fedramp:value-set[@name eq 'attachment-type']//fedramp:enum/@value"/>
   <!--RULE -->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@uuid = (//@href[matches(., '^#')] ! substring-after(., '#'))">
...
This resource lacks a reference within the document.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:back-matter/oscal:resource/oscal:prop[@name eq 'type']" priority="1002" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:back-matter/oscal:resource/oscal:prop[@name eq 'type']"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="@value = $attachment-types"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $attachment-types">
...
Found unknown attachment type «<xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="oscal:back-matter/oscal:resource/oscal:rlink" priority="1001" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:back-matter/oscal:resource/oscal:rlink"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="@href"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($use-remote-resources) or unparsed-text-available(@href)">
...
<xsl:template match="oscal:rlink | oscal:base64" priority="1000" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:rlink | oscal:base64" role="error"/>
      <xsl:variable name="media-types" select="$fedramp-values//fedramp:value-set[@name eq 'media-type']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@media-type = $media-types"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@media-type = $media-types">
...
<xsl:template match="oscal:back-matter/oscal:resource" priority="1001" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:back-matter/oscal:resource"/>
      <!--ASSERT warning-->
<xsl:choose>
...
This resource must not have more than one base64 element.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:back-matter/oscal:resource/oscal:base64" priority="1000" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:back-matter/oscal:resource/oscal:base64"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@filename"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(normalize-space(), '^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/][AQgw]==|[A-Za-z0-9+/]{2}[AEIMQUYcgkosw048]=)?$')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'fedramp-logo']]">
...
This FedRAMP SSP lacks the FedRAMP Logo.</svrl:diagnostic-reference>
      ...
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'user-guide']]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'user-guide']]">
               <xsl:attribute name="id">has-user-guide</xsl:attribute>
               <xsl:attribute name="role">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>A FedRAMP SSP
                must have a User Guide attached.</svrl:text>
...
This FedRAMP SSP lacks a User Guide.</svrl:diagnostic-reference>
      ...
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'rules-of-behavior']]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'rules-of-behavior']]">
               ...
               <svrl:text> A
                FedRAMP SSP must have Rules of Behavior.</svrl:text>
...
This FedRAMP SSP lacks a Rules of Behavior.</svrl:diagnostic-reference>
      ...
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'information-system-contingency-plan']]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'information-system-contingency-plan']]">
...
This FedRAMP SSP lacks a Contingency Plan.</svrl:diagnostic-reference>
      ...
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'configuration-management-plan']]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'configuration-management-plan']]">
...
This FedRAMP SSP lacks a Configuration Management Plan.</svrl:diagnostic-reference>
      ...
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'incident-response-plan']]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'incident-response-plan']]">
               ...
               <svrl:text>A
                FedRAMP SSP must have an Incident Response Plan attached.</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:resource[oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'type' and @value eq 'separation-of-duties-matrix']]">
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Policy and Procedure attachments</svrl:text>
   ...
   <!--RULE -->
<xsl:template match="oscal:implemented-requirement[matches(@control-id, '^[a-z]{2}-1$')]" priority="1001" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:implemented-requirement[matches(@control-id, '^[a-z]{2}-1$')]">
         <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §6</xsl:attribute>
      </svrl:fired-rule>
      <!--ASSERT warning-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(: legacy approach :) (descendant::oscal:by-component/oscal:link[@rel eq 'policy']) or (: component approach :) (some $c in //oscal:component[@uuid = current()/descendant::oscal:by-component/@component-uuid] satisfies $c/@type = 'policy' and $c/oscal:link[@rel eq 'policy'])">
...
implemented-requirement <xsl:text/>
      ...
      <xsl:variable name="policy-hrefs" select="distinct-values((descendant::oscal:by-component/oscal:link[@rel eq 'policy']/@href, //oscal:component[@type = 'policy' and @uuid = current()/descendant::oscal:by-component/@component-uuid]/oscal:link/@href) ! substring-after(., '#'))"/>
      <!--ASSERT warning-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $ref in $policy-hrefs satisfies exists(//oscal:resource[oscal:prop[@name eq 'type' and @value eq 'policy']][@uuid eq $ref])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(: legacy approach :) (descendant::oscal:by-component/oscal:link[@rel eq 'procedure']) or (: component approach :) (some $c in //oscal:component[@uuid = current()/descendant::oscal:by-component/@component-uuid] satisfies $c/@type = 'procedure' and $c/oscal:link[@rel eq 'procedure'])">
...
implemented-requirement <xsl:text/>
      ...
      <xsl:variable name="procedure-hrefs" select="distinct-values((descendant::oscal:by-component/oscal:link[@rel eq 'procedure']/@href, //oscal:component[@type = 'procedure' and @uuid = current()/descendant::oscal:by-component/@component-uuid]/oscal:link/@href) ! substring-after(., '#'))"/>
      <!--ASSERT warning-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(: targets of links exist in the document :) every $ref in $procedure-hrefs satisfies exists(//oscal:resource[oscal:prop[@name eq 'type' and @value eq 'procedure']][@uuid eq $ref])">
...
implemented-requirement <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="oscal:by-component/oscal:link[@rel = ('policy', 'procedure')]" priority="1000" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:by-component/oscal:link[@rel = ('policy', 'procedure')]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not( (: the current @href is not in :) @href = (: all controls except the current :) (//oscal:implemented-requirement[matches(@control-id, '^[a-z]{2}-1$')] except $ir) (: all their @hrefs :)/descendant::oscal:by-component/oscal:link[@rel eq 'policy']/@href )">
...
<xsl:template match="oscal:system-implementation" priority="1003" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-implementation"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:component[@type eq 'validation']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:component[@type eq 'validation']">
...
This FedRAMP SSP does not declare one or more FIPS 140 validated modules.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:component[@type eq 'validation']" priority="1002" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type eq 'validation']"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@name eq 'validation-reference']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'validation-reference']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:link[@rel eq 'validation-details']">
...
This validation component or inventory-item lacks a validation-details link.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'validation-reference']" priority="1001" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'validation-reference']"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="matches(@value, '^\d{3,4}$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(@value, '^\d{3,4}$')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = tokenize(following-sibling::oscal:link[@rel eq 'validation-details']/@href, '/')[last()]">
...
This validation-reference property does not match its sibling validation-details
   ...
   <!--RULE -->
<xsl:template match="oscal:link[@rel eq 'validation-details']" priority="1000" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:link[@rel eq 'validation-details']"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="matches(@href, '^https://csrc\.nist\.gov/projects/cryptographic-module-validation-program/[Cc]ertificate/\d{3,4}$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="matches(@href, '^https://csrc\.nist\.gov/projects/cryptographic-module-validation-program/[Cc]ertificate/\d{3,4}$')">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="tokenize(@href, '/')[last()] = preceding-sibling::oscal:prop[@name eq 'validation-reference']/@value">
...
<xsl:template match="oscal:system-characteristics" priority="1003" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-characteristics"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:security-sensitivity-level"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:security-sensitivity-level">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:security-impact-level">
...
<xsl:template match="oscal:security-sensitivity-level" priority="1002" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:security-sensitivity-level"/>
      <xsl:variable name="security-sensitivity-levels" select="$fedramp-values//fedramp:value-set[@name eq 'security-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current() = $security-sensitivity-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="current() = $security-sensitivity-levels">
...
Invalid security-sensitivity-level "<xsl:text/>
      ...
      <xsl:variable name="security-level-string" select="string-join(../oscal:security-impact-level//text())"/>
      <xsl:variable name="security-impact-level" select="                     if (matches($security-level-string, 'high'))                     then                         ('fips-199-high')                     else                         (if (matches($security-level-string, 'moderate'))                         then                             ('fips-199-moderate')                         else                             ('fips-199-low'))"/>
      <xsl:variable name="securitySensitivityLevel" select="."/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test=". eq $security-impact-level"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test=". eq $security-impact-level">
               ...
               <svrl:text>
                  <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="$security-level-string"/> -- A FedRAMP SSP security sensitivity level must match the highest level within the security
...
<xsl:template match="oscal:security-impact-level" priority="1001" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:security-impact-level"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:security-objective-confidentiality"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:security-objective-confidentiality">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:security-objective-integrity">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:security-objective-availability">
...
This FedRAMP SSP lacks an availability security objective.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:security-objective-confidentiality | oscal:security-objective-integrity | oscal:security-objective-availability" priority="1000" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:security-objective-confidentiality | oscal:security-objective-integrity | oscal:security-objective-availability"/>
      <xsl:variable name="security-objective-levels" select="$fedramp-values//fedramp:value-set[@name eq 'security-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current() = $security-objective-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="current() = $security-objective-levels">
...
Invalid "<xsl:text/>
      ...
      <xsl:variable name="impact-name" select="substring-after(substring-after(local-name(), '-'), '-')"/>
      <xsl:variable name="impact-selected" select="string-join(/oscal:system-security-plan/oscal:system-characteristics/oscal:system-information//oscal:information-type//*[contains(local-name(), $impact-name)]/oscal:selected/text())"/>
      <xsl:variable name="impactBase" select="string-join(/oscal:system-security-plan/oscal:system-characteristics/oscal:system-information//oscal:information-type//*[contains(local-name(), $impact-name)]/oscal:base/text())"/>
      <xsl:variable name="security-impact-level-selected" select="                     if (matches($impact-selected, 'high'))                     then                         ('fips-199-high')                     else                         (if (matches($impact-selected, 'moderate'))                         then                             ('fips-199-moderate')                         else                             (if (matches($impact-selected, 'low'))                             then                                 ('fips-199-low')                             else                                 ('fips-199-low')))"/>
      <xsl:variable name="security-impact-level-base" select="                     if (matches($impactBase, 'high'))                     then                         ('fips-199-high')                     else                         (if (matches($impactBase, 'moderate'))                         then                             ('fips-199-moderate')                         else                             (if (matches($impactBase, 'low'))                             then                                 ('fips-199-low')                             else                                 ('fips-199-low')))"/>
      <xsl:variable name="impactValue" select="                     if ($security-impact-level-selected ne '')                     then                         ($security-impact-level-selected)                     else                         ($security-impact-level-base)"/>
      <!--ASSERT warning-->
<xsl:choose>
...
The FedRAMP SSP security objective <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="substring-after(substring-after(local-name(), '-'), '-')"/> does not match the <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="substring-after(substring-after(local-name(), '-'), '-')"/> impact value.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M47"/>
...
<xsl:template match="oscal:system-information" priority="1005" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-information"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:template match="oscal:information-type" priority="1004" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:information-type"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:title"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:confidentiality-impact">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:availability-impact">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@system eq 'https://doi.org/10.6028/NIST.SP.800-60v2r1'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:information-type-id">
...
<xsl:template match="oscal:information-type-id" priority="1002" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:information-type-id"/>
      <xsl:variable name="information-types" select="doc(concat($registry-base-path, '/information-types.xml'))//fedramp:information-type/@id"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current()[. = $information-types]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="current()[. = $information-types]">
...
A FedRAMP SSP information-type-id lacks a SP 800-60v2r1 identifier.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:confidentiality-impact | oscal:integrity-impact | oscal:availability-impact" priority="1001" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:confidentiality-impact | oscal:integrity-impact | oscal:availability-impact"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:base ne oscal:selected) then exists(oscal:adjustment-justification) else true()">
...
<xsl:template match="oscal:base | oscal:selected" priority="1000" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:base | oscal:selected"/>
      <xsl:variable name="fips-199-levels" select="$fedramp-values//fedramp:value-set[@name eq 'security-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'identity-assurance-level']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'authenticator-assurance-level']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'federation-assurance-level']">
...
A FedRAMP SSP may lack a Digital Identity Determination federation-assurance-level
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'identity-assurance-level']" priority="1002" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'identity-assurance-level']"/>
      <xsl:variable name="identity-assurance-levels" select="$fedramp-values//fedramp:value-set[@name eq 'identity-assurance-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $identity-assurance-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $identity-assurance-levels">
...
A FedRAMP SSP may lack an allowed Digital Identity Determination
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'authenticator-assurance-level']" priority="1001" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'authenticator-assurance-level']"/>
      <xsl:variable name="authenticator-assurance-levels" select="$fedramp-values//fedramp:value-set[@name eq 'authenticator-assurance-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $authenticator-assurance-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $authenticator-assurance-levels">
...
A FedRAMP SSP may lack an allowed Digital Identity Determination
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'federation-assurance-level']" priority="1000" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'federation-assurance-level']"/>
      <xsl:variable name="federation-assurance-levels" select="$fedramp-values//fedramp:value-set[@name eq 'federation-assurance-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $federation-assurance-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $federation-assurance-levels">
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">FedRAMP OSCAL System Inventory</svrl:text>
   ...
   <!--RULE -->
<xsl:template match="/oscal:system-security-plan/oscal:system-implementation" priority="1012" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/oscal:system-security-plan/oscal:system-implementation"/>
      <doc:rule xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron">A FedRAMP SSP must incorporate inventory-item elements</doc:rule>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:template match="oscal:prop[@name eq 'asset-id']" priority="1010" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'asset-id']"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="count(//oscal:prop[@name eq 'asset-id'][@value eq current()/@value]) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(//oscal:prop[@name eq 'asset-id'][@value eq current()/@value]) = 1">
...
This asset id <xsl:text/>
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'asset-type']" priority="1009" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'asset-type']"/>
      <xsl:variable name="asset-types" select="$fedramp-values//fedramp:value-set[@name eq 'asset-type']//fedramp:enum/@value"/>
      <!--ASSERT information-->
<xsl:choose>
...
<xsl:template match="oscal:prop[@name eq 'virtual']" priority="1008" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'virtual']"/>
      <xsl:variable name="virtuals" select="$fedramp-values//fedramp:value-set[@name eq 'virtual']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:template match="oscal:prop[@name eq 'public']" priority="1007" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'public']"/>
      <xsl:variable name="publics" select="$fedramp-values//fedramp:value-set[@name eq 'public']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'allows-authenticated-scan']" priority="1006" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'allows-authenticated-scan']"/>
      <xsl:variable name="allows-authenticated-scans" select="$fedramp-values//fedramp:value-set[@name eq 'allows-authenticated-scan']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $allows-authenticated-scans"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $allows-authenticated-scans">
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@name eq 'is-scanned']" priority="1005" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@name eq 'is-scanned']"/>
      <xsl:variable name="is-scanneds" select="$fedramp-values//fedramp:value-set[@name eq 'is-scanned']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'scan-type']" priority="1004" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'scan-type']"/>
      <xsl:variable name="scan-types" select="$fedramp-values//fedramp:value-set[@name eq 'scan-type']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:template match="oscal:component" priority="1002" mode="M50">
      ...
      <xsl:variable name="component-types" select="$fedramp-values//fedramp:value-set[@name eq 'component-type']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(: not(@uuid = //oscal:inventory-item/oscal:implemented-component/@component-uuid) or :) oscal:prop[@name eq 'asset-type']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(oscal:prop[@name eq 'asset-type'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'asset-id']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(oscal:prop[@name eq 'asset-id'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'asset-type']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'virtual']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(oscal:prop[@name eq 'virtual'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'public']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(oscal:prop[@name eq 'public'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'scan-type']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(oscal:prop[@name eq 'scan-type'][2])">
...
This inventory-item has more than one scan-type property.</svrl:diagnostic-reference>
      ...
      <xsl:variable name="is-infrastructure" select="exists(oscal:prop[@name eq 'asset-type' and @value = ('os', 'infrastructure')])"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="not($is-infrastructure) or oscal:prop[@name eq 'allows-authenticated-scan']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or oscal:prop[@name eq 'allows-authenticated-scan']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or not(oscal:prop[@name eq 'allows-authenticated-scan'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or oscal:prop[@name eq 'baseline-configuration-name']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or not(oscal:prop[@name eq 'baseline-configuration-name'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or oscal:prop[(: @ns eq 'https://fedramp.gov/ns/oscal' and :)@name eq 'vendor-name']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or not(oscal:prop[(: @ns eq 'https://fedramp.gov/ns/oscal' and :)@name eq 'vendor-name'][2])">
...
This inventory-item has more than one vendor-name property.</svrl:diagnostic-reference>
      ...
      <xsl:variable name="prohibit-vendor" select="                     ('Dahua Technology Company', 'Dahua',                     'Hangzhou Hikvision Digital Technology', 'Hangzhou',                     'Hikvision', 'Hangzhou Hikvision',                     'Huawei', 'Huawei Technologies Company',                     'HyTera', 'Hytera Communications Corporation',                     'AO Kaspersky Lab', 'Kaspersky Lab', 'Kaspersky',                     'ZTE', 'ZTE Corporation',                     'China Mobile', 'China Mobile International USA Inc',                     'China Telecom', 'China Telecom (Americas) Corp')"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="not(oscal:prop[@name eq 'vendor-name']/@value = $prohibit-vendor)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(oscal:prop[@name eq 'vendor-name']/@value = $prohibit-vendor)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or oscal:prop[(: @ns eq 'https://fedramp.gov/ns/oscal' and :)@name eq 'hardware-model']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or not(oscal:prop[(: @ns eq 'https://fedramp.gov/ns/oscal' and :)@name eq 'hardware-model'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or oscal:prop[@name eq 'is-scanned']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-infrastructure) or not(oscal:prop[@name eq 'is-scanned'][2])">
...
This inventory-item has more than one is-scanned property.</svrl:diagnostic-reference>
      ...
      <xsl:variable name="is-software-and-database" select="exists(oscal:prop[@name eq 'asset-type' and @value = ('software', 'database')])"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="not($is-software-and-database) or oscal:prop[@name eq 'software-name']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-software-and-database) or oscal:prop[@name eq 'software-name']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-software-and-database) or not(oscal:prop[@name eq 'software-name'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-software-and-database) or oscal:prop[@name eq 'software-version']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-software-and-database) or not(oscal:prop[@name eq 'software-version'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-software-and-database) or oscal:prop[@name eq 'function']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($is-software-and-database) or not(oscal:prop[@name eq 'function'][2])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:prop[@name eq 'ipv4-address']) then (oscal:prop[@name eq 'ipv6-address']) else (true())">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:prop[@name eq 'ipv4-address']) then (oscal:prop[matches(@value, '(^[0-9][0-9]?[0-9]?\.[0-9][0-9]?[0-9]?\.[0-9][0-9]?[0-9]?\.[0-9][0-9]?[0-9]?$)')]) else (true())">
               ...
               <svrl:text>
                  <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:prop[@name = 'asset-id']/@value"/> must have an appropriate IPv4 value.</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'ipv4-address']/@value ne '0.0.0.0'">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:prop[@name eq 'ipv6-address']) then (oscal:prop[matches(@value, $IPv6-regex)]) else (true())">
               ...
               <svrl:text>
                  <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:prop[@name = 'asset-id']/@value"/> must have an appropriate IPv6 value.</svrl:text>
...
<xsl:template match="oscal:system-implementation" priority="1001" mode="M51">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-implementation">
         <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §5.4.6</xsl:attribute>
      </svrl:fired-rule>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-internal' and @value castable as xs:integer and @value cast as xs:integer ge 0]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-internal' and @value castable as xs:integer and @value cast as xs:integer ge 0]">
               <xsl:attribute name="id">has-users-internal</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>A
                FedRAMP SSP must specify the number of current internal users.</svrl:text>
               <svrl:diagnostic-reference diagnostic="has-users-internal-diagnostic">
This FedRAMP SSP does not specify the number of current internal users.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-external' and @value castable as xs:integer and @value cast as xs:integer ge 0]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-external' and @value castable as xs:integer and @value cast as xs:integer ge 0]">
               <xsl:attribute name="id">has-users-external</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>A
                FedRAMP SSP must specify the number of current external users.</svrl:text>
               <svrl:diagnostic-reference diagnostic="has-users-external-diagnostic">
This FedRAMP SSP does not specify the number of current external users.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-internal-future' and @value castable as xs:integer and @value cast as xs:integer ge 0]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-internal-future' and @value castable as xs:integer and @value cast as xs:integer ge 0]">
               <xsl:attribute name="id">has-users-internal-future</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>A
                FedRAMP SSP must specify the number of future internal users.</svrl:text>
               <svrl:diagnostic-reference diagnostic="has-users-internal-future-diagnostic">
This FedRAMP SSP does not specify the number of future internal users.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-external-future' and @value castable as xs:integer and @value cast as xs:integer ge 0]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name = 'users-external-future' and @value castable as xs:integer and @value cast as xs:integer ge 0]">
               <xsl:attribute name="id">has-users-external-future</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>A
                FedRAMP SSP must specify the number of future external users.</svrl:text>
               <svrl:diagnostic-reference diagnostic="has-users-external-future-diagnostic">
This FedRAMP SSP does not specify the number of future external users.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT error-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:component[@type eq 'this-system'])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (//*[matches(lower-case(.), $email-string)]) then (if (../oscal:control-implementation/oscal:implemented-requirement[@control-id eq 'si-8']//*[matches(., 'DMARC')] and ../oscal:control-implementation/oscal:implemented-requirement[@control-id eq 'si-8']//*[matches(., 'SPF')] and ../oscal:control-implementation/oscal:implemented-requirement[@control-id eq 'si-8']//*[matches(., 'DKIM')]) then (false()) else (true())) else (true())">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:system-id[@identifier-type eq 'https://fedramp.gov']">
               <xsl:attribute name="id">has-system-id</xsl:attribute>
               <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.1</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(tokenize(normalize-space(oscal:description), '\s+')) ge 32">
...
This FedRAMP SSP has a description less than 32 words in length.</svrl:diagnostic-reference>
      ...
      <xsl:variable name="authorization-types" select="$fedramp-values//fedramp:value-set[@name eq 'authorization-type']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'authorization-type' and @value = $authorization-types]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'authorization-type' and @value = $authorization-types]">
               <xsl:attribute name="id">has-fedramp-authorization-type</xsl:attribute>
               <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.2</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:variable name="fedramp_data_href" select="'https://raw.githubusercontent.com/18F/fedramp-data/master/data/data.json'"/>
   <xsl:variable name="fedramp_data" select="                 if ($use-remote-resources and unparsed-text-available($fedramp_data_href)) then                     parse-json(unparsed-text($fedramp_data_href))                 else                     nilled(())"/>
   <!--RULE -->
<xsl:template match="oscal:system-characteristics/oscal:system-id[@identifier-type eq 'https://fedramp.gov']" priority="1001" mode="M52">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-characteristics/oscal:system-id[@identifier-type eq 'https://fedramp.gov']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($use-remote-resources) or (some $p in array:flatten($fedramp_data?data?Providers) satisfies $p?Package_ID eq current())">
...
This FedRAMP SSP does not have an active FedRAMP system identifier.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:system-security-plan/oscal:system-implementation/oscal:leveraged-authorization" priority="1000" mode="M52">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-security-plan/oscal:system-implementation/oscal:leveraged-authorization"/>
      <xsl:variable name="id" select="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'leveraged-system-identifier']/@value"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="                     oscal:prop[                     @ns eq 'https://fedramp.gov/ns/oscal' and                     @name eq 'leveraged-system-identifier' and                     @value ne '']                     "/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[ @ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'leveraged-system-identifier' and @value ne '']">
...
Component _<xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:title"/>_ is missing an identifier.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT warning-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not($use-remote-resources) or (some $p in array:flatten($fedramp_data?data?Providers) satisfies ($p?Package_ID eq $id and $p?Cloud_Service_Provider_Package eq current()/oscal:title))">
...
<xsl:template match="oscal:metadata" priority="1004" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:metadata">
         <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §4.6-§4.11</xsl:attribute>
      </svrl:fired-rule>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:role[@id eq 'system-owner']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'system-owner']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'authorizing-official']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'system-poc-management']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'system-poc-technical']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'system-poc-other']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'information-system-security-officer']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:role[@id eq 'authorizing-official-poc']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//oscal:responsible-party[@role-id eq current()/@id]">
...
<xsl:template match="oscal:responsible-party" priority="1002" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:responsible-party"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="exists(//oscal:role[@id eq current()/@role-id])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(//oscal:role[@id eq current()/@role-id])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $p in oscal:party-uuid satisfies exists(//oscal:party[@uuid eq $p])">
...
This responsible-party has a party-uuid for a non-existent party.</svrl:diagnostic-reference>
      ...
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="                     if (                     current()/@role-id = (                     'system-owner',                     'authorizing-official',                     'system-poc-management',                     'system-poc-technical',                     'system-poc-other',                     'information-system-security-officer',                     'authorizing-official-poc'                     )                     )                     then                         every $p in oscal:party-uuid                             satisfies                             exists(//oscal:party[@uuid eq $p and @type eq 'person'])                     else                         true()                     "/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if ( current()/@role-id = ( 'system-owner', 'authorizing-official', 'system-poc-management', 'system-poc-technical', 'system-poc-other', 'information-system-security-officer', 'authorizing-official-poc' ) ) then every $p in oscal:party-uuid satisfies exists(//oscal:party[@uuid eq $p and @type eq 'person']) else true()">
...
<xsl:template match="oscal:party[@type eq 'person']" priority="1001" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:party[@type eq 'person']"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="//oscal:responsible-party[oscal:party-uuid = current()/@uuid]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//oscal:responsible-party[oscal:party-uuid = current()/@uuid]">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(//oscal:responsible-party[oscal:party-uuid = current()/@uuid]) eq 1">
               ...
               <svrl:diagnostic-reference diagnostic="party-has-one-responsibility-diagnostic">
                  <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:name"/> - This person has more than one responsibility.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M53"/>
   ...
   <!--RULE -->
<xsl:template match="oscal:location[oscal:prop[@value eq 'data-center']]" priority="1000" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:location[oscal:prop[@value eq 'data-center']]"/>
      <!--ASSERT warning-->
<xsl:choose>
         <xsl:when test="count(../oscal:location[oscal:prop[@value eq 'data-center']]) &gt; 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../oscal:location[oscal:prop[@value eq 'data-center']]) &gt; 1">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../oscal:location/oscal:prop[@value eq 'data-center'][@class eq 'primary']) = 1">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(../oscal:location/oscal:prop[@value eq 'data-center'][@class eq 'alternate']) &gt; 0">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:address/oscal:country">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:address/oscal:country eq 'US'">
...
<xsl:template match="oscal:implemented-requirement" priority="1001" mode="M54">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:implemented-requirement">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(: implementation-status is not-applicable :) exists(oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status' and @value eq 'not-applicable']) or (: responsible-role exists :) exists(oscal:responsible-role)">
...
<xsl:template match="oscal:responsible-role" priority="1000" mode="M54">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:responsible-role"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="//oscal:role/@id = current()/@role-id"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//oscal:role/@id = current()/@role-id">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'type']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'privilege-level']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal'][@name eq 'sensitivity']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:authorized-privilege">
...
<xsl:template match="oscal:user/oscal:role-id" priority="1006" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:user/oscal:role-id"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="//oscal:role[@id eq current()]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//oscal:role[@id eq current()]">
...
This role-id references a non-existent role definition.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:user/oscal:prop[@name eq 'type']" priority="1005" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:user/oscal:prop[@name eq 'type']"/>
      <xsl:variable name="user-types" select="$fedramp-values//fedramp:value-set[@name eq 'user-type']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current()/@value = $user-types"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="current()/@value = $user-types">
...
This user type property lacks an allowed value.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:user/oscal:prop[@name eq 'privilege-level']" priority="1004" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:user/oscal:prop[@name eq 'privilege-level']"/>
      <xsl:variable name="user-privilege-levels" select="$fedramp-values//fedramp:value-set[@name eq 'user-privilege']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current()/@value = $user-privilege-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="current()/@value = $user-privilege-levels">
...
User privilege-level property has an allowed value.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:user/oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal'][@name eq 'sensitivity']" priority="1003" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:user/oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal'][@name eq 'sensitivity']"/>
      <xsl:variable name="user-sensitivity-levels" select="$fedramp-values//fedramp:value-set[@name eq 'user-sensitivity-level']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current()/@value = $user-sensitivity-levels"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="current()/@value = $user-sensitivity-levels">
...
This user sensitivity level property lacks an allowed value.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:user/oscal:authorized-privilege" priority="1002" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:user/oscal:authorized-privilege"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:title"/>
         <xsl:otherwise>
...
This authorized-privilege lacks one or more
   ...
   <!--RULE -->
<xsl:template match="oscal:authorized-privilege/oscal:title" priority="1001" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:authorized-privilege/oscal:title"/>
      <!--ASSERT error-->
<xsl:choose>
...
This authorized-privilege title is empty.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:authorized-privilege/oscal:function-performed" priority="1000" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:authorized-privilege/oscal:function-performed"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="current() ne ''"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:authorization-boundary">
...
<xsl:template match="oscal:authorization-boundary" priority="1002" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:authorization-boundary"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:description"/>
         <xsl:otherwise>
...
This FedRAMP SSP lacks at least one authorization-boundary diagram.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:authorization-boundary/oscal:diagram" priority="1001" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:authorization-boundary/oscal:diagram"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@uuid"/>
         <xsl:otherwise>
...
This FedRAMP SSP authorization-boundary diagram lacks a
   ...
   <!--RULE -->
<xsl:template match="oscal:authorization-boundary/oscal:diagram/oscal:link" priority="1000" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:authorization-boundary/oscal:diagram/oscal:link"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@rel"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(//oscal:resource[@uuid eq substring-after(current()/@href, '#')])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:network-architecture">
...
<xsl:template match="oscal:network-architecture" priority="1002" mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:network-architecture"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:description"/>
         <xsl:otherwise>
...
This FedRAMP SSP lacks at least one network-architecture diagram.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:network-architecture/oscal:diagram" priority="1001" mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:network-architecture/oscal:diagram"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@uuid"/>
         <xsl:otherwise>
...
This FedRAMP SSP network-architecture diagram lacks a caption.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:network-architecture/oscal:diagram/oscal:link" priority="1000" mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:network-architecture/oscal:diagram/oscal:link"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@rel"/>
         <xsl:otherwise>
...
<xsl:template match="oscal:data-flow/oscal:diagram" priority="1001" mode="M58">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:data-flow/oscal:diagram"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@uuid"/>
         <xsl:otherwise>
...
This FedRAMP SSP data-flow diagram lacks a caption.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:data-flow/oscal:diagram/oscal:link" priority="1000" mode="M58">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:data-flow/oscal:diagram/oscal:link"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@rel"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:import-profile)">
...
<xsl:template match="oscal:import-profile" priority="1006" mode="M59">
      ...
      <xsl:variable name="resolved-profile-import-url" select="                     if (starts-with(@href, '#'))                     then                         resolve-uri(/oscal:system-security-plan/oscal:back-matter/oscal:resource[substring-after(current()/@href, '#') = @uuid]/oscal:rlink[1]/@href, base-uri())                     else                         resolve-uri(@href, base-uri())"/>
      <xsl:variable name="resolved-profile-available" select="doc-available($resolved-profile-import-url)"/>
      <xsl:variable name="resolved-profile-doc" select="                     if ($resolved-profile-available)                     then                         doc($resolved-profile-import-url)                     else                         ()"/>
      <!--ASSERT fatal-->
<xsl:choose>
         <xsl:when test="@href"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$resolved-profile-available = true()">
...
<xsl:template match="oscal:control-implementation" priority="1005" mode="M59">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:control-implementation"/>
      <xsl:variable name="sensitivity-level" select="/ =&gt; lv:sensitivity-level()"/>
      <xsl:variable name="selected-profile" select="$sensitivity-level =&gt; lv:profile()"/>
      <xsl:variable name="required-controls" select="$selected-profile/*//oscal:control/@id ! xs:string(.)"/>
      <xsl:variable name="implemented-controls" select="oscal:implemented-requirement/@control-id ! xs:string(.)"/>
      <xsl:apply-templates select="*" mode="M59"/>
   </xsl:template>
   <!--RULE -->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status'])">
               <xsl:attribute name="id">implemented-requirement-has-implementation-status</xsl:attribute>
               <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §5.3</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status' and @value eq 'planned']) then exists(current()/oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'planned-completion-date']) else true()">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'control-origination']">
               <xsl:attribute name="id">implemented-requirement-has-control-origination</xsl:attribute>
               <xsl:attribute name="see">Guide to OSCAL-based FedRAMP System Security Plans §5.3.1.1</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
This implemented-requirement lacks a control-origination
      ...
      <xsl:variable name="control-originations" select="$fedramp-values//fedramp:value-set[@name eq 'control-origination']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'control-origination' and @value = $control-originations]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'control-origination' and @value = $control-originations]">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'control-origination' and @value eq 'inherited']) then (: there must be a leveraged-authorization-uuid property :) exists(oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'leveraged-authorization-uuid']) and (: the referenced leveraged-authorization must exist :) exists(//oscal:leveraged-authorization[@uuid = current()/oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'leveraged-authorization-uuid']/@value]) else true()">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status' and @value eq 'partial']) then exists(oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status' and @value eq 'planned']) else true()">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $c in string-join(distinct-values((oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status']/@value)), '-') satisfies $c = ('implemented', 'planned', 'alternative', 'not-applicable', 'partial-planned', 'planned-partial')">
...
This implemented-requirement has an invalid
      ...
      <xsl:variable name="sensitivity-level" select="/ =&gt; lv:sensitivity-level() =&gt; lv:if-empty-default('')"/>
      <xsl:variable name="selected-profile" select="$sensitivity-level =&gt; lv:profile()"/>
      <xsl:variable name="required-response-points" select="$selected-profile/oscal:catalog//oscal:control[@id = current()/@control-id]/oscal:part[@name = 'statement']/descendant-or-self::oscal:part[oscal:prop[@name = 'response-point']]/@id"/>
      <xsl:variable name="provided-response-points" select="oscal:statement/@statement-id"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="                     every $rrp in $required-response-points                         satisfies $rrp = $provided-response-points"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $rrp in $required-response-points satisfies $rrp = $provided-response-points">
               <xsl:attribute name="id">implemented-requirement-has-required-response-points</xsl:attribute>
               <xsl:attribute name="role">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>An implemented control must include required response point
                statements.</svrl:text>
               <svrl:diagnostic-reference diagnostic="implemented-requirement-has-required-response-points-diagnostic">
This implemented requirement is missing required response point(s).
            Required response points are <xsl:text/>
                  <xsl:value-of select="$required-response-points"/>
                  <xsl:text/>; only <xsl:text/>
                  <xsl:value-of select="$provided-response-points"/>
                  <xsl:text/>) response point(s) are provided.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT error-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $i in $selected-profile//oscal:control[@id eq current()/@control-id]/oscal:param[not(oscal:value)]/@id satisfies exists(oscal:set-parameter[@param-id eq $i])">
 ...
 For Control <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/> - Some values of the SSP set-parameter/@param-id attributes do not match the corresponding control/param/@id
            values in the baseline catalog. SSP set-parameter/@param-id values - <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:set-parameter/@param-id"/> Catalog param/@id values- <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="$selected-profile//oscal:control[@id eq current()/@control-id]/oscal:param[not(oscal:value)]/@id"/>.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT error-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $i in current()//oscal:set-parameter/@param-id satisfies exists($selected-profile//oscal:control[@id eq current()/@control-id]/oscal:param[@id eq $i])">
 ...
 For Control <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/> - Some values of the control/param/@id in the baseline catalog do not match the corresponding SSP
            set-parameter/@param-id attribute values. Catalog param/@id values- <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="$selected-profile//oscal:control[@id eq current()/@control-id]/oscal:param[not(oscal:value)]/@id"/> SSP
            set-parameter/@param-id values - <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="oscal:set-parameter/@param-id"/>.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT warning-->
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (matches(@control-id, 'ia-2.11')) then (if (self::oscal:implemented-requirement//*[matches(., 'CMVP validated|NIAP Certification|NSA approval')]) then (true()) else (false())) else (true())">
...
The implemented requirement <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="@control-id"/> does not contain the strings 'CMVP validated' or 'NIAP Certification' or 'NSA approval'.</svrl:diagnostic-reference>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M59"/>
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status']" priority="1003" mode="M59">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'implementation-status']"/>
      <xsl:variable name="control-implementation-statuses" select="$fedramp-values//fedramp:value-set[@name eq 'control-implementation-status']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $control-implementation-statuses"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $control-implementation-statuses">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if (@value ne 'implemented') then oscal:remarks else true()">
...
This incomplete control implementation lacks an
   ...
   <!--RULE -->
<xsl:template match="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'planned-completion-date']" priority="1002" mode="M59">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'planned-completion-date']"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value castable as xs:date"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value castable as xs:date">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(@value castable as xs:date) or (@value castable as xs:date and xs:date(@value) gt current-date())">
...
This planned completion date references a past time.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:inherited/oscal:description" priority="1001" mode="M59">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:inherited/oscal:description"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="count(tokenize(normalize-space(.), '\s+')) ge 32"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(tokenize(normalize-space(.), '\s+')) ge 32">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="if ($selected-profile//oscal:param[@id eq current()/@param-id]/oscal:constraint) then ($selected-profile//oscal:param[@id eq current()/@param-id][oscal:constraint/oscal:description/oscal:p eq current()/oscal:value]) else (true())">
...
The parameter <xsl:value-of xmlns:doc="https://fedramp.gov/oscal/fedramp-automation-documentation" xmlns:feddoc="http://us.gov/documentation/federal-documentation" xmlns:sch="http://purl.oclc.org/dsdl/schematron" select="current()/@param-id"/> does not match the corresponding baseline resolved profile catalog parameter constraint description
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Cloud Service and Deployment Models</svrl:text>
   <xsl:variable name="service-models" select="$fedramp-values//fedramp:value-set[@name eq 'service-model']//fedramp:enum/@value"/>
   <xsl:variable name="deployment-models" select="$fedramp-values//fedramp:value-set[@name eq 'deployment-model']//fedramp:enum/@value"/>
   <!--RULE -->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'cloud-service-model']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'cloud-service-model' and @value = $service-models]">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'cloud-service-model' and @value = ('saas', 'paas')] and ../oscal:system-implementation/oscal:leveraged-authorization">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $p in oscal:prop[@name eq 'cloud-service-model' and @value eq 'other'] satisfies exists($p/oscal:remarks)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'cloud-deployment-model']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'cloud-deployment-model' and @value = $deployment-models]">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $p in oscal:prop[@name eq 'cloud-deployment-model' and @value eq 'hybrid-cloud'] satisfies exists($p/oscal:remarks)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(: either there is no component or inventory-item tagged as 'public' :) not( exists(//oscal:component[oscal:prop[@name eq 'public' and @value eq 'yes']]) or exists(//oscal:inventory-item[oscal:prop[@name eq 'public' and @value eq 'yes']]) ) or (: a 'public-cloud' deployment model is employed :) exists(oscal:prop[@name eq 'cloud-deployment-model' and @value eq 'public-cloud'])">
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Interconnections</svrl:text>
   <!--RULE -->
<xsl:template match="oscal:component[@type = 'interconnection']/oscal:prop[@name eq 'interconnection-direction']" priority="1004" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type = 'interconnection']/oscal:prop[@name eq 'interconnection-direction']"/>
      <xsl:variable name="interconnection-direction-values" select="$fedramp-values//fedramp:value-set[@name eq 'interconnection-direction']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $interconnection-direction-values"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $interconnection-direction-values">
...
A system interconnection lacks an allowed
   ...
   <!--RULE -->
<xsl:template match="oscal:component[@type = 'interconnection']/oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'interconnection-security']" priority="1003" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type = 'interconnection']/oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'interconnection-security']"/>
      <xsl:variable name="interconnection-security-values" select="$fedramp-values//fedramp:value-set[@name eq 'interconnection-security']//fedramp:enum/@value"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@value = $interconnection-security-values"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value = $interconnection-security-values">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@value ne 'other' or exists(oscal:remarks)">
...
This system interconnection defines an alternate method for
   ...
   <!--RULE -->
<xsl:template match="oscal:component[@type eq 'interconnection']" priority="1002" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type eq 'interconnection']"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="oscal:title"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@name eq 'interconnection-direction']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'information']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'service-processor']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(oscal:prop[@name eq 'ipv4-address' and @class eq 'local'] and oscal:prop[@name eq 'ipv4-address' and @class eq 'remote']) or (oscal:prop[@name eq 'ipv6-address' and @class eq 'local'] and oscal:prop[@name eq 'ipv6-address' and @class eq 'remote'])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'interconnection-security']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:prop[@ns eq 'https://fedramp.gov/ns/oscal' and @name eq 'circuit']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:responsible-role[@role-id eq 'isa-poc-local']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:responsible-role[@role-id eq 'isa-poc-remote']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:responsible-role[@role-id eq 'isa-authorizing-official-local']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:responsible-role[@role-id eq 'isa-authorizing-official-remote']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:responsible-role/oscal:party-uuid) and (every $rp in descendant::oscal:party-uuid satisfies exists(//oscal:party[@uuid eq $rp and @type eq 'person']))">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $p in oscal:responsible-role[matches(@role-id, 'local$')]/oscal:party-uuid satisfies not($p = oscal:responsible-role[matches(@role-id, 'remote$')]/oscal:party-uuid)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $p in oscal:responsible-role[matches(@role-id, 'remote$')]/oscal:party-uuid satisfies not($p = oscal:responsible-role[matches(@role-id, 'local$')]/oscal:party-uuid)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:link[@rel eq 'isa-agreement']">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="oscal:link[@rel eq 'isa-agreement' and matches(@href, '^#')]">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $href in oscal:link[@rel eq 'agreement']/@href satisfies exists(//oscal:resource[@uuid eq substring-after($href, '#')])">
...
This system interconnection cites an absent interconnection
   ...
   <!--RULE -->
<xsl:template match="oscal:component[@type eq 'interconnection']/oscal:protocol" priority="1001" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type eq 'interconnection']/oscal:protocol"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="@name"/>
         <xsl:otherwise>
...
This system interconnection protocol lacks one or more port range
   ...
   <!--RULE -->
<xsl:template match="oscal:component[@type eq 'interconnection']/oscal:protocol/oscal:port-range" priority="1000" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type eq 'interconnection']/oscal:protocol/oscal:port-range"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:template match="oscal:system-implementation" priority="1000" mode="M62">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:system-implementation"/>
      <xsl:variable name="expected-network-protocols" select="'DNS', 'NTP', 'SSH', 'HTTPS', 'TLS'"/>
      <!--ASSERT information-->
<xsl:choose>
         <xsl:when test="                     every $p in $expected-network-protocols                         satisfies exists(//oscal:protocol[upper-case(@name) eq $p])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="every $p in $expected-network-protocols satisfies exists(//oscal:protocol[upper-case(@name) eq $p])">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:component[@type eq 'DNS-authoritative-service'])">
...
No DNS authoritative service is specified in the SSP.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:component[@type eq 'DNS-authoritative-service']" priority="1001" mode="M63">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[@type eq 'DNS-authoritative-service']"/>
      <!--ASSERT error-->
<xsl:choose>
         <xsl:when test="exists(oscal:prop[@name eq 'DNS-zone' and exists(@value)])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(oscal:prop[@name eq 'DNS-zone' and exists(@value)])">
...
A DNS authoritative service is specified but no zones are specified.</svrl:diagnostic-reference>
   ...
   <!--RULE -->
<xsl:template match="oscal:component[$use-remote-resources][@type eq 'DNS-authoritative-service' and oscal:status/@state eq 'operational']/oscal:prop[@name eq 'DNS-zone']" priority="1000" mode="M63">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="oscal:component[$use-remote-resources][@type eq 'DNS-authoritative-service' and oscal:status/@state eq 'operational']/oscal:prop[@name eq 'DNS-zone']"/>
      <xsl:variable name="zone-regex" select="'^ ([a-z0-9]+ (-[a-z0-9]+)*\.)+ [a-z]{2,} \.? $'"/>
...
The DNS zone "<xsl:text/>
      ...
      <xsl:variable name="DoH-target" select="                     if (ends-with(@value, '.')) then                         @value                     else                         concat(@value, '.')"/>
      <xsl:variable name="DoH_query" select="concat('https://dns.google/resolve?name=', $DoH-target, '&amp;type=SOA')"/>
      <xsl:variable name="DoH-response" select="                     if ($well-formed) then                         unparsed-text($DoH_query)                     else                         ()"/>
      <xsl:variable name="response" select="                     if ($well-formed) then                         parse-json($DoH-response)                     else                         ()"/>
      <xsl:variable name="has-resolved-zone" select="                     if ($well-formed) then                         $response?Status eq 0 and map:contains($response, 'Answer')                     else                         false()"/>
      <!--ASSERT error-->
<xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$has-resolved-zone and $response?AD eq true()">
